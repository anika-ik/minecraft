...
function down(){
    if(player_y<=500){
        player_y= player_y+block_image_height;
        console.log("block image height= "+ block_image_height);
        console.log("when down arraow key is pressed, X= "+player_x+" ,Y= " + player_y);
        canvas.remove(player_objects);
        player_updatde();
    }
}
...
function left(){
    if(player_x>0){
        ...
        console.log("when left arraow key is pressed, X= "+player_x+" ,Y= " + player_y);
        canvas.remove(player_objects);
        player_updatde();
    }
}
